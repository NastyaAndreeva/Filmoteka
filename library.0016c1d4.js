 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e||"",l),new ze(null);const f=window.open(e||"",l,h);b(f,t,"popup-blocked");try{f.focus()}catch(t){}return new ze(f)}const qe="emulator/auth/handler";function He(t,e,n,s,o,a){b(t.config.authDomain,t,"auth-domain-config-required"),b(t.config.apiKey,t,"invalid-api-key");const l={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:s,v:i.SDK_VERSION,eventId:o};if(e instanceof _t){e.setDefaultLanguage(t.languageCode),l.providerId=e.providerId||"",(0,r.isEmpty)(e.getCustomParameters())||(l.customParameters=JSON.stringify(e.getCustomParameters()));for(const[t,e]of Object.entries(a||{}))l[t]=e}if(e instanceof Et){const t=e.getScopes().filter((t=>""!==t));t.length>0&&(l.scopes=t.join(","))}t.tenantId&&(l.tid=t.tenantId);const c=l;for(const t of Object.keys(c))void 0===c[t]&&delete c[t];return`${function({config:t}){return t.emulator?C(t,qe):`https://${t.authDomain}/__/auth/handler`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
